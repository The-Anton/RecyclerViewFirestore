...
public class Resources {
    ...
    public static final videoPlayerData[] PLAYER_DATA = {
            new videoPlayerData("Sending Data to a New Activity with Intent Extras",
            ...
            new videoPlayerData("REST API, Retrofit2, MVVM Course SUMMARY",
            ...
            new videoPlayerData("MVVM and LiveData",
            ...
            new videoPlayerData("Swiping Views with a ViewPager",
            ...
            new videoPlayerData("Database Cache, MVVM, Retrofit, REST API demo for upcoming course",
